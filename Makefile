...
# this is the experimental command
#override CFLAGS += -mthumb -mthumb-interwork -O2 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -Wall -Wextra
ROM := $(MODERN_ROM_NAME)
