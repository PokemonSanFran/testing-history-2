...
#define PSF_FLAG_1304                                        (SYSTEM_FLAGS + 0x10)
#define PSF_FLAG_1305                                        (SYSTEM_FLAGS + 0x11)
#define PSF_FLAG_1306                                        (SYSTEM_FLAGS + 0x12)
#define PSF_FLAG_1307                                        (SYSTEM_FLAGS + 0x13)
#define PSF_FLAG_1308                                        (SYSTEM_FLAGS + 0x14)
#define PSF_FLAG_1309                                        (SYSTEM_FLAGS + 0x15)
#define PSF_FLAG_1310                                        (SYSTEM_FLAGS + 0x16)
#define PSF_FLAG_1311                                        (SYSTEM_FLAGS + 0x17)
