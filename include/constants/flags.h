...
#define FLAG_DEFEATED_LAB_DYNAMAX                            0x98
#define FLAG_DEFEATED_CONSTRUCTION_ROCKET_A                  0x99
#define FLAG_DEFEATED_CONSTRUCTION_ROCKET_B                  0x9A
#define FLAG_DEFEATED_CONSTRUCTION_MON_A                     0x9B
#define FLAG_DEFEATED_CONSTRUCTION_MON_B                     0x9C
#define FLAG_RECIEVED_NURSERY_EGG                            0x9D
#define FLAG_CANCEL_RESTORED_BATTLE_ROOM                     0x9E
#define FLAG_CHOSEN_RESTORED_MULTI_BATTLE_NPC_PARTNER        0x9F
...
#define FLAG_VISITED_SUNSET                                         (SYSTEM_FLAGS + 0x20)
#define FLAG_VISITED_GLDNGTEPARK                                         (SYSTEM_FLAGS + 0x21)
#define FLAG_VISITED_PRESIDIO                                         (SYSTEM_FLAGS + 0x22)
#define FLAG_VISITED_PACIFICA                                         (SYSTEM_FLAGS + 0x23)
#define FLAG_VISITED_CASTRO                                         (SYSTEM_FLAGS + 0x24)
#define FLAG_VISITED_MISSION                                         (SYSTEM_FLAGS + 0x25)
#define FLAG_VISITED_DOGPATCH                                         (SYSTEM_FLAGS + 0x26)
#define FLAG_VISITED_SOUTHBAY                                         (SYSTEM_FLAGS + 0x27)
#define FLAG_VISITED_OAKLAND                                         (SYSTEM_FLAGS + 0x28)
#define FLAG_VISITED_MARIN                                         (SYSTEM_FLAGS + 0x29)
#define FLAG_VISITED_BERKELEY                                         (SYSTEM_FLAGS + 0x2A)
#define FLAG_VISITED_TENDERLOIN                                         (SYSTEM_FLAGS + 0x2B)
#define FLAG_VISITED_CHINATOWN                                         (SYSTEM_FLAGS + 0x2C)
#define FLAG_VISITED_JAPANTOWN                                         (SYSTEM_FLAGS + 0x2D)
#define FLAG_VISITED_SOMA                                         (SYSTEM_FLAGS + 0x2E)
#define FLAG_VISITED_BERNALHEIGHTS                                         (SYSTEM_FLAGS + 0x2F)
#define FLAG_VISITED_ALAMEDA                                         (SYSTEM_FLAGS + 0x30)
#define FLAG_VISITED_HAIGHTASHBURY                                         (SYSTEM_FLAGS + 0x31)
#define FLAG_VISITED_TWINPEAKS                                         (SYSTEM_FLAGS + 0x32)
#define FLAG_VISITED_NAVALBASE                                         (SYSTEM_FLAGS + 0x33)
#define FLAG_VISITED_PAINTEDLADIES                                         (SYSTEM_FLAGS + 0x34)
#define FLAG_VISITED_MORAGASTEPS                                         (SYSTEM_FLAGS + 0x35)
#define FLAG_VISITED_DEYOUNGMUSEUM                                         (SYSTEM_FLAGS + 0x36)
#define FLAG_VISITED_DUTCHWINDMILLS                                         (SYSTEM_FLAGS + 0x37)
#define FLAG_VISITED_LOMBARDSTREET                                         (SYSTEM_FLAGS + 0x38)
#define FLAG_VISITED_PALACEFINEARTS                                         (SYSTEM_FLAGS + 0x39)
#define FLAG_VISITED_FORTPOINT                                         (SYSTEM_FLAGS + 0x3A)
#define FLAG_VISITED_TRANSPYRAMID                                         (SYSTEM_FLAGS + 0x3B)
#define FLAG_VISITED_FERRYBUILDING                                         (SYSTEM_FLAGS + 0x3C)
#define PSF_FLAG_1319 (SYSTEM_FLAGS + 0x3D)
#define FLAG_VISITED_FISHERMANSWHARF                                         (SYSTEM_FLAGS + 0x3E)
#define FLAG_VISITED_CHASECENTER                                         (SYSTEM_FLAGS + 0x3F)
#define FLAG_VISITED_OAKLANDCOLISEUM                                         (SYSTEM_FLAGS + 0x40)
#define FLAG_VISITED_OAKLANDFERRY                                         (SYSTEM_FLAGS + 0x41)
#define FLAG_VISITED_GLDNGTEBRIDGE                                         (SYSTEM_FLAGS + 0x42)
#define FLAG_VISITED_ROBINWILLTUNNEL                                         (SYSTEM_FLAGS + 0x43)
#define FLAG_VISITED_MUIRWOODS                                         (SYSTEM_FLAGS + 0x44)
#define FLAG_VISITED_LAKEMERRITT                                         (SYSTEM_FLAGS + 0x45)
#define FLAG_VISITED_LAKEMERCED                                         (SYSTEM_FLAGS + 0x46)
#define FLAG_VISITED_TREASUREISLAND                                         (SYSTEM_FLAGS + 0x47)
#define FLAG_VISITED_TWINPEAKS_BASE (SYSTEM_FLAGS + 0x48)
#define FLAG_VISITED_ALCATRAZ                                         (SYSTEM_FLAGS + 0x49)
#define PSF_FLAG_1321 (SYSTEM_FLAGS + 0x4A)
#define FLAG_VISITED_PSFROUTE1                                         (SYSTEM_FLAGS + 0x4B)
#define FLAG_VISITED_PSFROUTE2                                         (SYSTEM_FLAGS + 0x4C)
#define FLAG_VISITED_PSFROUTE5                                         (SYSTEM_FLAGS + 0x4D)
#define FLAG_VISITED_PSFROUTE7                                         (SYSTEM_FLAGS + 0x4E)
#define FLAG_VISITED_PSFROUTE8                                         (SYSTEM_FLAGS + 0x4F)
#define FLAG_VISITED_PSFROUTE9                                         (SYSTEM_FLAGS + 0x50)
#define FLAG_VISITED_PSFROUTE11                                         (SYSTEM_FLAGS + 0x51)
#define FLAG_VISITED_PSFROUTE12                                         (SYSTEM_FLAGS + 0x52)
#define FLAG_VISITED_PSFROUTE13                                         (SYSTEM_FLAGS + 0x53)
#define FLAG_VISITED_PSFROUTE14                                         (SYSTEM_FLAGS + 0x54)
#define FLAG_VISITED_PSFROUTE15                                         (SYSTEM_FLAGS + 0x55)
#define FLAG_VISITED_PSFROUTE17                                         (SYSTEM_FLAGS + 0x56)
#define FLAG_VISITED_PSFROUTE18                                         (SYSTEM_FLAGS + 0x57)
#define FLAG_VISITED_PSFROUTE19                                         (SYSTEM_FLAGS + 0x58)
#define FLAG_VISITED_PSFROUTE20                                         (SYSTEM_FLAGS + 0x59)
#define FLAG_VISITED_PSFROUTE21                                         (SYSTEM_FLAGS + 0x5A)
#define FLAG_VISITED_PSFROUTE22                                         (SYSTEM_FLAGS + 0x5B)
#define FLAG_VISITED_PSFROUTE25                                         (SYSTEM_FLAGS + 0x5C)
#define FLAG_VISITED_PSFROUTE30                                         (SYSTEM_FLAGS + 0x5D)
#define FLAG_VISITED_PSFROUTE32                                         (SYSTEM_FLAGS + 0x5E)
#define FLAG_VISITED_PSFROUTE38                                         (SYSTEM_FLAGS + 0x5F)
#define FLAG_VISITED_PSFROUTE43                                         (SYSTEM_FLAGS + 0x60)
#define FLAG_VISITED_PSFROUTE49                                         (SYSTEM_FLAGS + 0x61)
#define FLAG_VISITED_PSFROUTE51                                         (SYSTEM_FLAGS + 0x62)
#define FLAG_VISITED_PSFROUTE61                                         (SYSTEM_FLAGS + 0x63)
#define FLAG_VISITED_PSFROUTE62                                         (SYSTEM_FLAGS + 0x64)
#define FLAG_VISITED_PSFROUTE63                                         (SYSTEM_FLAGS + 0x65)
#define FLAG_VISITED_PSFROUTE70                                         (SYSTEM_FLAGS + 0x66)
#define FLAG_VISITED_PSFROUTE72                                         (SYSTEM_FLAGS + 0x67)
#define FLAG_VISITED_PSFROUTE76                                         (SYSTEM_FLAGS + 0x68)
#define FLAG_VISITED_GLDNGTEWILDS                                         (SYSTEM_FLAGS + 0x69)
#define FLAG_VISITED_SALESFORCETOWER                                         (SYSTEM_FLAGS + 0x6A)
#define FLAG_VISITED_UNDERGROUNDLAB                                         (SYSTEM_FLAGS + 0x6B)
#define FLAG_VISITED_GLDNGTEWILDS_NORTH                                        (SYSTEM_FLAGS + 0x6C)
#define FLAG_VISITED_GLDNGTEWILDS_WEST                                        (SYSTEM_FLAGS + 0x6D)
#define FLAG_VISITED_GLDNGTEWILDS_EAST                                        (SYSTEM_FLAGS + 0x6E)
#define FLAG_VISITED_GLDNGTEWILDS_SOUTH                                        (SYSTEM_FLAGS + 0x6F)
