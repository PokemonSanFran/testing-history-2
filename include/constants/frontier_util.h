...
//PSF
#define FRONTIER_STREAK_GOLD 100
#define FRONTIER_STREAK_SILVER FRONTIER_STREAK_GOLD / 2
#define NUM_BOSS_SLOTS  20
#define BOSS_CYCLE (NUM_BOSS_SLOTS * FRONTIER_STAGES_PER_CHALLENGE)

//PSF_GetFrontierBrainStatus
#define FRONTIER_BRAIN_NOT_READY        0
#define FRONTIER_BRAIN_SILVER_FIRST     1
#define FRONTIER_BRAIN_SILVER_REMATCH   2
#define FRONTIER_BRAIN_SILVER_COMPLETE  3
#define FRONTIER_BRAIN_GOLD_FIRST       4
#define FRONTIER_BRAIN_GOLD_COMPLETE    5
