...
#define TMHM_COUNT 400 // PSF technicalmachine Branch
...
//Save Boot
#define GAME_OPTIONS_SAVE_BOOT_TRADITIONAL 0
#define GAME_OPTIONS_SAVE_BOOT_CONTINUE    1
