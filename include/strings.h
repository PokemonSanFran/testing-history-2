...
extern const u8 gText_PokemonStorageSystem[];
...
//PSF Locations
extern const u8 gText_Sunset[];
extern const u8 gText_Gldngtepark[];
extern const u8 gText_Presidio[];
extern const u8 gText_Pacifica[];
extern const u8 gText_Castro[];
extern const u8 gText_Mission[];
extern const u8 gText_Dogpatch[];
extern const u8 gText_Southbay[];
extern const u8 gText_Oakland[];
extern const u8 gText_Marin[];
extern const u8 gText_Berkeley[];
extern const u8 gText_Tenderloin[];
extern const u8 gText_Chinatown[];
extern const u8 gText_Japantown[];
extern const u8 gText_Soma[];
extern const u8 gText_Bernalheights[];
extern const u8 gText_Alameda[];
extern const u8 gText_Haightashbury[];
extern const u8 gText_Twinpeaks[];
extern const u8 gText_Navalbase[];
extern const u8 gText_Paintedladies[];
extern const u8 gText_Moragasteps[];
extern const u8 gText_Deyoungmuseum[];
extern const u8 gText_Dutchwindmills[];
extern const u8 gText_Lombardstreet[];
extern const u8 gText_Palacefinearts[];
extern const u8 gText_Fortpoint[];
...
extern const u8 gText_Chasecenter[];
extern const u8 gText_Oaklandcoliseum[];
extern const u8 gText_Oaklandferry[];
extern const u8 gText_Gldngtebridge[];
extern const u8 gText_Robinwilltunnel[];
extern const u8 gText_Muirwoods[];
extern const u8 gText_Lakemerritt[];
extern const u8 gText_Lakemerced[];
...
extern const u8 gText_Psfroute1[];
extern const u8 gText_Psfroute2[];
extern const u8 gText_Psfroute5[];
extern const u8 gText_Psfroute7[];
extern const u8 gText_Psfroute8[];
extern const u8 gText_Psfroute9[];
extern const u8 gText_Psfroute11[];
extern const u8 gText_Psfroute12[];
extern const u8 gText_Psfroute13[];
extern const u8 gText_Psfroute14[];
extern const u8 gText_Psfroute15[];
extern const u8 gText_Psfroute17[];
extern const u8 gText_Psfroute18[];
extern const u8 gText_Psfroute19[];
extern const u8 gText_Psfroute20[];
extern const u8 gText_Psfroute21[];
extern const u8 gText_Psfroute22[];
extern const u8 gText_Psfroute25[];
extern const u8 gText_Psfroute30[];
extern const u8 gText_Psfroute32[];
extern const u8 gText_Psfroute38[];
extern const u8 gText_Psfroute43[];
extern const u8 gText_Psfroute49[];
extern const u8 gText_Psfroute51[];
extern const u8 gText_Psfroute61[];
extern const u8 gText_Psfroute62[];
extern const u8 gText_Psfroute63[];
extern const u8 gText_Psfroute70[];
extern const u8 gText_Psfroute72[];
extern const u8 gText_Psfroute76[];
extern const u8 gText_Gldngtewilds[];
extern const u8 gText_Salesforcetower[];
extern const u8 gText_Undergroundlab[];
