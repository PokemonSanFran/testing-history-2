...
static const u8 Preset_Options[NUM_OF_PRESET_OPTIONS][NUM_MAX_SETTINGS][MAX_OPTIONS_PER_SETTING] = {
    ...
    [BATTLE_SETTINGS] =
    {
        [BATTLE_PRESET_DEFAULT]  = {
            ...
            [BATTLE_OPTIONS_SWITCH_STYLE]           = 1,
            [BATTLE_OPTIONS_TAKE_WILD_ITEMS]        = 2,
            [BATTLE_OPTIONS_LAST_USED_BALL]         = 2,
            [BATTLE_OPTIONS_QUICK_RUN]              = 0,
            [BATTLE_OPTIONS_BATTLE_DIFFICULTY]      = 1,
        ...
        [BATTLE_PRESET_CHALLENGE]  = {
            ...
            [BATTLE_OPTIONS_LAST_USED_BALL]         = 2,
            [BATTLE_OPTIONS_QUICK_RUN]              = 0,
            [BATTLE_OPTIONS_BATTLE_DIFFICULTY]      = 2,
            [BATTLE_OPTIONS_FAINTED_MON]            = 0,
            [BATTLE_OPTIONS_FIRST_POKEMON_CATCH]    = 0,
            [BATTLE_OPTIONS_NICKNAME]               = 0,
            [BATTLE_OPTIONS_WHITEOUT]               = 0,
        ...
        [BATTLE_PRESET_SPEEDRUN]  = {
            ...
            [BATTLE_OPTIONS_SWITCH_STYLE]           = 1,
            [BATTLE_OPTIONS_TAKE_WILD_ITEMS]        = 2,
            [BATTLE_OPTIONS_LAST_USED_BALL]         = 1,
            [BATTLE_OPTIONS_QUICK_RUN]              = 0,
            [BATTLE_OPTIONS_BATTLE_DIFFICULTY]      = 1,
            [BATTLE_OPTIONS_FAINTED_MON]            = 0,
            [BATTLE_OPTIONS_FIRST_POKEMON_CATCH]    = 0,
        ...
        [BATTLE_PRESET_KAIZO]  = {
            ...
            [BATTLE_OPTIONS_LAST_USED_BALL]         = 1,
            [BATTLE_OPTIONS_QUICK_RUN]              = 2,
            [BATTLE_OPTIONS_BATTLE_DIFFICULTY]      = 3,
            [BATTLE_OPTIONS_FAINTED_MON]            = 0,
            [BATTLE_OPTIONS_FIRST_POKEMON_CATCH]    = 0,
            [BATTLE_OPTIONS_NICKNAME]               = 0,
            [BATTLE_OPTIONS_WHITEOUT]               = 0,
