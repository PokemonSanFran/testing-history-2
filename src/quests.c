...
static const struct SideQuest sSideQuests[QUEST_COUNT] =
{
	...
	side_quest(
	      gText_Quest_StopMugging_Name_5,
	      gText_Quest_StopMugging_Desc_5,
	      gText_Quest_StopMugging_DoneDesc_5,
	      gText_Quest_StopMugging_Map_5,
	...
	side_quest(
	      gText_Quest_StolenTrade_Name_6,
	      gText_Quest_StolenTrade_Desc_6,
	      gText_Quest_StolenTrade_DoneDesc_6,
	      gText_Quest_StolenTrade_Map_6,
