...
const struct SideQuest sSideQuests[QUEST_COUNT] = {
    ...
    [QUEST_LASTMUSICVENUEINSANFRANCISCO] =
        side_quest(
    ...
    [QUEST_UNKNOWNGOVERNMENTSOCIALMEDIAQUEST] =
        side_quest(
    ...
    [QUEST_UNKNOWNCONSTRUCTIONSTRIKEQUEST] =
        side_quest(
    ...
    [QUEST_TAXICABTURNAROUND] =
        side_quest(
                gText_Quest_Taxicabturnaround_Name,
                gText_Quest_Taxicabturnaround_Desc,
                gText_Quest_Taxicabturnaround_DoneDesc,
                gText_Quest_Taxicabturnaround_Map,
                OBJ_EVENT_GFX_TRUCK,
                OBJECT,
    ...
    [QUEST_LETS_BURN_THIS_MOTHER_DOWN] =
        side_quest(
