...
static u8 GetMapsecType(u16 mapSecId) // Hardcoded Fly Flag locations
{
    switch (mapSecId)
    {
        ...
        case MAPSEC_SUNSET:
            return FlagGet(FLAG_VISITED_SUNSET) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_GLDNGTEPARK:
            return FlagGet(FLAG_VISITED_GLDNGTEPARK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PRESIDIO:
            return FlagGet(FLAG_VISITED_PRESIDIO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PACIFICA:
            return FlagGet(FLAG_VISITED_PACIFICA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_CASTRO:
            return FlagGet(FLAG_VISITED_CASTRO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_MISSION:
            return FlagGet(FLAG_VISITED_MISSION) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_DOGPATCH:
            return FlagGet(FLAG_VISITED_DOGPATCH) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_SOUTHBAY:
            return FlagGet(FLAG_VISITED_SOUTHBAY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_OAKLAND:
            return FlagGet(FLAG_VISITED_OAKLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_MARIN:
            return FlagGet(FLAG_VISITED_MARIN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_BERKELEY:
            return FlagGet(FLAG_VISITED_BERKELEY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_TENDERLOIN:
            return FlagGet(FLAG_VISITED_TENDERLOIN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_CHINATOWN:
            return FlagGet(FLAG_VISITED_CHINATOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_JAPANTOWN:
            return FlagGet(FLAG_VISITED_JAPANTOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_SOMA:
            return FlagGet(FLAG_VISITED_SOMA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_BERNALHEIGHTS:
            return FlagGet(FLAG_VISITED_BERNALHEIGHTS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_ALAMEDA:
            return FlagGet(FLAG_VISITED_ALAMEDA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_HAIGHTASHBURY:
            return FlagGet(FLAG_VISITED_HAIGHTASHBURY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_TWINPEAKS:
            return FlagGet(FLAG_VISITED_TWINPEAKS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_NAVALBASE:
            return FlagGet(FLAG_VISITED_NAVALBASE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PAINTEDLADIES:
            return FlagGet(FLAG_VISITED_PAINTEDLADIES) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        ...
        case MAPSEC_LOMBARDSTREET:
            return FlagGet(FLAG_VISITED_LOMBARDSTREET) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PALACEFINEARTS:
            return FlagGet(FLAG_VISITED_PALACEFINEARTS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_FORTPOINT:
            return FlagGet(FLAG_VISITED_FORTPOINT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        ...
        case MAPSEC_DRAGONGATE:
            return FlagGet(FLAG_VISITED_DRAGONGATE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_FISHERMANSWHARF:
            return FlagGet(FLAG_VISITED_FISHERMANSWHARF) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_CHASECENTER:
            return FlagGet(FLAG_VISITED_CHASECENTER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_OAKLANDCOLISEUM:
            return FlagGet(FLAG_VISITED_OAKLANDCOLISEUM) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_OAKLANDFERRY:
            return FlagGet(FLAG_VISITED_OAKLANDFERRY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_GLDNGTEBRIDGE:
            return FlagGet(FLAG_VISITED_GLDNGTEBRIDGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_ROBINWILLTUNNEL:
            return FlagGet(FLAG_VISITED_ROBINWILLTUNNEL) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_MUIRWOODS:
            return FlagGet(FLAG_VISITED_MUIRWOODS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_LAKEMERRITT:
            return FlagGet(FLAG_VISITED_LAKEMERRITT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_LAKEMERCED:
            return FlagGet(FLAG_VISITED_LAKEMERCED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_TREASUREISLAND:
            return FlagGet(FLAG_VISITED_TREASUREISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_SILICONVALLEY:
            return FlagGet(FLAG_VISITED_SILICONVALLEY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_ALCATRAZ:
            return FlagGet(FLAG_VISITED_ALCATRAZ) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFCAVE8:
            return FlagGet(FLAG_VISITED_PSFCAVE8) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE1:
            return FlagGet(FLAG_VISITED_PSFROUTE1) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE2:
            return FlagGet(FLAG_VISITED_PSFROUTE2) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE5:
            return FlagGet(FLAG_VISITED_PSFROUTE5) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE7:
            return FlagGet(FLAG_VISITED_PSFROUTE7) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE8:
            return FlagGet(FLAG_VISITED_PSFROUTE8) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE9:
            return FlagGet(FLAG_VISITED_PSFROUTE9) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE11:
            return FlagGet(FLAG_VISITED_PSFROUTE11) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE12:
            return FlagGet(FLAG_VISITED_PSFROUTE12) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE13:
            return FlagGet(FLAG_VISITED_PSFROUTE13) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE14:
            return FlagGet(FLAG_VISITED_PSFROUTE14) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE15:
            return FlagGet(FLAG_VISITED_PSFROUTE15) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE17:
            return FlagGet(FLAG_VISITED_PSFROUTE17) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE18:
            return FlagGet(FLAG_VISITED_PSFROUTE18) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE19:
            return FlagGet(FLAG_VISITED_PSFROUTE19) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE20:
            return FlagGet(FLAG_VISITED_PSFROUTE20) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE21:
            return FlagGet(FLAG_VISITED_PSFROUTE21) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE22:
            return FlagGet(FLAG_VISITED_PSFROUTE22) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE25:
            return FlagGet(FLAG_VISITED_PSFROUTE25) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE30:
            return FlagGet(FLAG_VISITED_PSFROUTE30) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE32:
            return FlagGet(FLAG_VISITED_PSFROUTE32) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE38:
            return FlagGet(FLAG_VISITED_PSFROUTE38) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE43:
            return FlagGet(FLAG_VISITED_PSFROUTE43) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE49:
            return FlagGet(FLAG_VISITED_PSFROUTE49) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE51:
            return FlagGet(FLAG_VISITED_PSFROUTE51) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE61:
            return FlagGet(FLAG_VISITED_PSFROUTE61) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE62:
            return FlagGet(FLAG_VISITED_PSFROUTE62) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE63:
            return FlagGet(FLAG_VISITED_PSFROUTE63) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE70:
            return FlagGet(FLAG_VISITED_PSFROUTE70) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE72:
            return FlagGet(FLAG_VISITED_PSFROUTE72) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_PSFROUTE76:
            return FlagGet(FLAG_VISITED_PSFROUTE76) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_GLDNGTEWILDS:
            return FlagGet(FLAG_VISITED_GLDNGTEWILDS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_SALESFORCETOWER:
            return FlagGet(FLAG_VISITED_SALESFORCETOWER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case MAPSEC_UNDERGROUNDLAB:
            return FlagGet(FLAG_VISITED_UNDERGROUNDLAB) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        default:
