...
const u16 gMessageBox_Pal[] = INCBIN_U16("graphics/text_window/message_box_psf.gbapal");
const u8 gMessageBox_Gfx[] = INCBIN_U8("graphics/text_window/message_box_psf.4bpp");
