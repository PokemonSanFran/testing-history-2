...
const u8 gText_Quest_SocialMedia_Desc[] =_("Description");
const u8 gText_Quest_SocialMedia_DoneDesc[] =_("DoneDescription");
const u8 gText_Quest_SocialMedia_Map[] =_("Alameda");
...
const u8 gText_Quest_InstallNatureProbes_Desc[] =_("Description");
const u8 gText_Quest_InstallNatureProbes_DoneDesc[] =_("DoneDescription");
...
const u8 gText_Quest_ArtisanBalls1_Desc[] =_("Description");
const u8 gText_Quest_ArtisanBalls1_DoneDesc[] =_("DoneDescription");
...
const u8 gText_Quest_SocialMedia_Sub1_Name[] = _("Rabies Outleak");
const u8 gText_Quest_SocialMedia_Sub1_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub1_Map[] = _("BernalHeights");
const u8 gText_Quest_SocialMedia_Sub2_Name[] = _("Primary Source");
const u8 gText_Quest_SocialMedia_Sub2_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub2_Map[] = _("Tenderloin");
const u8 gText_Quest_SocialMedia_Sub3_Name[] = _("Blue Robbery");
const u8 gText_Quest_SocialMedia_Sub3_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub3_Map[] = _("Castro");
const u8 gText_Quest_SocialMedia_Sub4_Name[] = _("Ice Cream Crafting");
const u8 gText_Quest_SocialMedia_Sub4_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub4_Map[] = _("Berkeley");
const u8 gText_Quest_SocialMedia_Sub5_Name[] = _("VS Deoxys");
const u8 gText_Quest_SocialMedia_Sub5_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub5_Map[] = _("LakeMerced");
const u8 gText_Quest_SocialMedia_Sub6_Name[] = _("Chinatown Tunnels");
const u8 gText_Quest_SocialMedia_Sub6_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub6_Map[] = _("Chinatown");
const u8 gText_Quest_SocialMedia_Sub7_Name[] = _("Freshwater Evolution");
const u8 gText_Quest_SocialMedia_Sub7_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub7_Map[] = _("GldnGtePark");
const u8 gText_Quest_SocialMedia_Sub8_Name[] = _("Gem Artist");
const u8 gText_Quest_SocialMedia_Sub8_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub8_Map[] = _("Pacifica");
const u8 gText_Quest_SocialMedia_Sub9_Name[] = _("Between a Stone and a Hard Place");
const u8 gText_Quest_SocialMedia_Sub9_Desc[] = _("Sub Lorem");
const u8 gText_Quest_SocialMedia_Sub9_Map[] = _("Presidio");
...
const u8 gText_Quest_CutePokemon_Sub1_Map[] = _("Bernal Heights");
...
const u8 gText_Quest_CutePokemon_Sub3_Map[] = _("Richmond");
...
const u8 gText_Quest_ArtisanBalls_Sub1_Name[] = _("Fast");
const u8 gText_Quest_ArtisanBalls_Sub1_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub1_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub2_Name[] = _("Level");
const u8 gText_Quest_ArtisanBalls_Sub2_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub2_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub3_Name[] = _("Lure");
const u8 gText_Quest_ArtisanBalls_Sub3_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub3_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub4_Name[] = _("Heavy");
const u8 gText_Quest_ArtisanBalls_Sub4_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub4_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub5_Name[] = _("Love");
const u8 gText_Quest_ArtisanBalls_Sub5_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub5_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub6_Name[] = _("Friend");
const u8 gText_Quest_ArtisanBalls_Sub6_Desc[] = _("Sub Lorem");
const u8 gText_Quest_ArtisanBalls_Sub6_Map[] = _("N/A");
const u8 gText_Quest_ArtisanBalls_Sub7_Name[] = _("Moon");
const u8 gText_Quest_ArtisanBalls_Sub7_Desc[] = _("Sub Lorem");
