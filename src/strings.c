...
const u8 gText_BirchCustom4[] = _("Done");
...
//quest flavor
const u8 gText_Players_Adventure_Flavor1[] = _("Explore everything eastern SanFran has to offer on your way to the Championship.");
const u8 gText_Players_Adventure_Flavor2[] = _("Head back to the Compound in Southbay and get a good night's sleep.");
const u8 gText_Players_Adventure_Flavor3[] = _("Go to the Ferrybuilding and take the ferry to Alameda. Head to Berkeley for your next badge!");
const u8 gText_Players_Adventure_Flavor4[] = _("Backtrack down Psfroute22 to get back to the Alameda Ferry.");
const u8 gText_Players_Adventure_Flavor5[] = _("Complete the challenge on Alcatraz and learn more about SanFran's history.");
const u8 gText_Players_Adventure_Flavor6[] = _("Explore everything western SanFran has to offer on your way to the Championship.");
const u8 gText_Players_Adventure_Flavor7[] = _("Head to the Chasecenter construction site on Psfroute22.");
const u8 gText_Players_Adventure_Flavor8[] = _("Defeat the Garbordor holding the stadium hostage!");
const u8 gText_Players_Adventure_Flavor9[] = _("Head back to the Compound in Southbay and get a good night's sleep.");
const u8 gText_Players_Adventure_Flavor10[] = _("Complete all of Siebold's challenges in Muirwoods.");
const u8 gText_Players_Adventure_Flavor11[] = _("Join the police raid on Team Rocket's base!");
const u8 gText_Players_Adventure_Flavor12[] = _("Head back to the Compound in Southbay. The Championship begins first thing tomorrow!");
const u8 gText_Players_Adventure_Flavor13[] = _("Go the Chasecenter and get ready for the Championship!");
const u8 gText_Players_Adventure_Flavor14[] = _("Take a walk, cool your head before the matches start.");
const u8 gText_Players_Adventure_Flavor15[] = _("Head to the Arena for your Group Stage match. Good luck!");
const u8 gText_Players_Adventure_Flavor16[] = _("Head to the Arena for your Semifinal match. Good luck!");
const u8 gText_Players_Adventure_Flavor17[] = _("Watch Archer vs Bianca from the Skybox.");
const u8 gText_Players_Adventure_Flavor18[] = _("Go the Arena, and face Archer for the Championship!");
...
const u8 gText_Players_Adventure_Flavor22[] = _("Have lunch with Archer on Treasureisland.");
const u8 gText_Players_Adventure_Flavor23[] = _("Help Archer out with his project. Talk to them on Treasureisland to figure out where to start.");
const u8 gText_Players_Adventure_Flavor24[] = _("Head to the Salesforcetower to talk to Ycombinator.");
const u8 gText_Players_Adventure_Flavor25[] = _("Head to Alcatraz to talk to TeamRocket.");
const u8 gText_Players_Adventure_Flavor26[] = _("Head back to the Compound in Presidio and get some rest. You've got a big decision to make.");
const u8 gText_Players_Adventure_Flavor27[] = _("Go to Alcatraz to help Team Rocket, or go to Salesforcetower to help Ycombinator.");
const u8 gText_Players_Adventure_Flavor28[] = _("You're back to the day of the big decision. Will you help TeamRocket at Alcatraz this time?");
const u8 gText_Players_Adventure_Flavor29[] = _("Head to the Salesforcetower to help take down TeamRocket once and for all.");
const u8 gText_Players_Adventure_Flavor30[] = _("TeamRocket is finished. You've done it.");
const u8 gText_Players_Adventure_Flavor31[] = _("Enter the Chasecenter Arena for your exhibition battle!");
const u8 gText_Players_Adventure_Flavor32[] = _("TeamRocket is disbanded. You're the Champion. Life is good.");
const u8 gText_Players_Adventure_Flavor33[] = _("If you want a do-over, head to the top of Twin Peaks.");
const u8 gText_Players_Adventure_Flavor34[] = _("Look all over SanFran to find clues on the location of Wikstrom.");
const u8 gText_Players_Adventure_Flavor35[] = _("Head to Oakland for the warehouse rave, or Alcatraz for the all hands meeting.");
const u8 gText_Players_Adventure_Flavor36[] = _("Which corporation should Teamrocket tackle first? Head to Alcatraz to start working on it!");
const u8 gText_Players_Adventure_Flavor37[] = _("Head back to Archer's house in Alameda and get a good night's sleep.");
const u8 gText_Players_Adventure_Flavor38[] = _("Is the message a clue? Meet the team at Psfroute8.");
const u8 gText_Players_Adventure_Flavor39[] = _("Head back to Alcatraz to regroup.");
const u8 gText_Players_Adventure_Flavor40[] = _("Head into the belly of the beast. Meet at Sabrina's house in Sunset.");
const u8 gText_Players_Adventure_Flavor41[] = _("Sabrina's home in the sunset has a warp tile directly into the Salesforce. It's time to finish this!");
const u8 gText_Players_Adventure_Flavor42[] = _("You became Champion, made some mistakes, but the region is just a little better because of your efforts. Thank you!");
const u8 gText_Players_Adventure_Flavor43[] = _("You became Champion, stamped out Ycombinator, and the region is a just a little better because of your efforts. Thank you!");
