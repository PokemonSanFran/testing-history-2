...
static void DrawMultichoiceMenuDynamic(u8 left, u8 top, u8 argc, struct ListMenuItem *items, bool8 ignoreBPress, u32 initalRow, u8 maxBeforeScroll, u32 callbackSet); //https://github.com/pret/pokeemerald/compare/master...SBird1337:pokeemerald:feature/dynmulti
...
bool8 ScriptMenu_MultichoiceDynamic(u8 left, u8 top, u8 argc, struct ListMenuItem *items, bool8 ignoreBPress, u8 maxBeforeScroll, u32 initalRow, u32 callbackSet)
{
    ...
    else
    {
        ...
        DrawMultichoiceMenuDynamic(left,top, argc, items, ignoreBPress, initalRow, maxBeforeScroll, callbackSet);
        return TRUE;
    }
}
//END DYNAMIC MULTICHOICE
...
static void MultichoiceDynamicEventDebug_OnSelectionChanged(struct DynamicListMenuEventArgs *eventArgs)
{
    DebugPrintf("OnSelectionChagned: %d", eventArgs->selectedItem);
}
