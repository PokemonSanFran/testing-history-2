static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PSFCITY15_PSFBADGUY_TOWER - 1] = {MAP_GROUP(PSFCITY15_PSFBADGUY_TOWER), MAP_NUM(PSFCITY15_PSFBADGUY_TOWER), 0, 0},
    [HEAL_LOCATION_PSFCITY15_PSFBADGUY_TOWER_1F - 1] = {MAP_GROUP(PSFCITY15_PSFBADGUY_TOWER_1F), MAP_NUM(PSFCITY15_PSFBADGUY_TOWER_1F), 0, 0},
};
